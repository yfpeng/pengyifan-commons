 ...
 *
 * The Stemmer class transforms a word into its root form. The input word can
 * be provided a character at time (by calling add()), or at once by calling
...
class PorterStemmer
{
   ...
   * ponies -> poni ties -> ti caress -> caress cats -> cat feed -> feed agreed
